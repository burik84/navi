...
const nameUku = {
  44_1: 'тит. 44.1 Узел коммерческого учета СУГ под давлением. Жидкая и паро-газовая фаза. Инструкции, описание, схемы.',
  44_2: 'тит. 44.2 Узел коммерческого учета СУГ охлажденных. Жидкая и паро-газовая фаза. Инструкция, описание, схемы.',
