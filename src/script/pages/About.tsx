  ...
  return (
    <>
      ...
      <main className="about">
        ...
        <p>Добавлены карты и описание Modbas для Стендеров, узлы учета топливного газа и другие</p>
        <p>Добавлен новый проект - Система загазованности. Реконструкция в резервуарном парке хранения СУГ.</p>
