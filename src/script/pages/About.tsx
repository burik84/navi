...
export const About: React.FC = () => {
  return (
    <div className="about">
      ...
      <p>
        Новый проект НАВИ основывается на опыте пользования предыдущих версий навигатора, которые помогали в работе, но
        отсутствовал дизайн.
      </p>
      ...
      <h3>О версии 4.18</h3>
      <p>Для реализации поставленной цели использовал библиотеку стилей - bootstrap ver.4. Все иконки от FontAwesome</p>
